...
const ICICC2020 = () => {
  return (
    ...
    <div className='relative flex justify-around ml-10 gap-x-[10rem]'>
    ...
    <h1 className=' absolute bottom-0 left-[18rem] font-bold text-blue-950 text-4xl '>IMAGE GALLERY</h1><br/>
    ...
    <Swiper
        ...
        className="mySwiper ml-[5rem] mt-3 width-[10rem]"
      >
