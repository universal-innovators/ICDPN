    ...
    <div className="container">
      ...
      <div className="sm:flex justify around gap-7 mt-5">
        <div className="sponser-text-container mb-8">
          ...
          <p className="text-justify tracking-wide mb-2 text-lg font-light">ICDPN-2026 will feature five parallel Tracks, each focusing on distinct areas. The major themes are identified (but not limited to) and listed below under the Conference Tracks.</p>
          <br />
          <hr />
          <br />
