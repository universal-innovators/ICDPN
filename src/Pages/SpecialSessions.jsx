...
const SpecialSessions = () => {
  return (
    <div>
      <div className='w-[90%] mt-6 mx-auto text-center text-blue-950 underline font-bold text-3xl bg-green-500 p-3 rounded-tl-3xl rounded-br-3xl'>Special Sessions</div>
