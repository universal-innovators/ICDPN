      ...
      <div className="flex flex-wrap sm:flex-nowrap justify-around gap-7">
        ...
        INVITATION LETTER FOR SPONSORSHIP
          ...
          <ul>
            ...
            <li>Technical poster paper representation among the best students of India</li>
            <li>Startup funding event for MAKE IN INDIA mission</li>
            <li>Invitation to possible investors for some of the best ideas</li>
            <li>Exhibits</li>
            <li>International parallel Workshops from national and international researchers and industry experts</li>
            <li>Expected audience of minimum 500, comprised of reseasrchers, scientists and people from academia and industry</li>
            <li>Last year version of the conference being held at Czech Republic, Europe, received papers of around 2600 authors from 25 different countries</li>
          </ul></p>
          <br />
