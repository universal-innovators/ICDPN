...
const Downloads = () => {
  return (
    <div>
      ...
      </button><Download className='absolute sm:right-[7rem] right-9 top-9'/></a></div>
      ...
      </button><Download className='absolute sm:right-[10rem] sm:top-[3.2rem] right-14 top-11'/></a></div>
          </div>
      ...
      </button><Download className='absolute sm:right-[8rem] right-[4rem] top-9'/></a></div>
      ...
      <button className=' w-[17rem] sm:w-[23rem] bg-blue-600 rounded-lg hover:bg-gradient-to-t from-blue-900 to-cyan-500 '>
        <div className='m-auto p-[2rem] text-white sm:px-[4rem]'>Special Session Proposal Template</div>
      </button><Download className='absolute sm:right-[8rem] sm:top-14 top-14 right-14'/></a></div>
          </div>
          <div className='flex gap-2 mb-5 flex-wrap'>
      ...
      </button><Download className='absolute sm:right-[6rem] right-[3.2rem] top-8'/></a></div>
      ...
      </button><Download className=' absolute right-[10rem] top-14'/></a></div>
          </div>
          <div className='flex gap-2 mb-5 flex-wrap'>
      ...
      </button><Download className='absolute sm:right-[10rem] right-9 top-14'/></a></div>
          </div>
