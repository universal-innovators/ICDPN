  ...
  return (
    <div className="container mb-8">
      ...
      <div className=" ml-3 mt-6 ">
        ...
        researchers from all over the world along with the leaders from the
        industry to explore the important topics of research. The two day
        ...
        researchers, developers, engineers, students, and practitioners. Another
        ...
        exploration into real time application. Kindly increase the value of the
        ...
        We have already got approval from some Scopus and high quality journals.
        (Soon will be declared) 
        <br />
        ...
        <br />
        7) Special discount for your personal paper if above conditions are met.
        (If minimum number of papers get registered in your session) 
        <br />
        8) Extra weightage and support will be provided for your session extended
        paper in SCI/ Scopus Journal.
        <br />
      ...
      <br />
      <a
        href="src\assets\Session_Proposal_Template.0f17863ff9e16d5c9c77 (3) .docx"
