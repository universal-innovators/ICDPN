    ...
    <div className="container mb-9">
      ...
      <div className="w-[90%] sm:overflow-auto overflow-scroll m-auto">
        <table className=" table1 bg-black text-white m-auto sm:w-10/12 mt-11">
          <thead>
            <th>Category</th>
            <th>Early Registration (before 30th August, 2024)</th>
            <th>Late Registration (after 30th August, 2024)</th>
          </thead>
          <tbody>
            <tr>
      ...
      <div className="w-[90%] mt-20 sm:overflow-auto overflow-scroll m-auto">
        ...
        <table className=" table1 bg-black text-white m-auto sm:w-10/12 mt-11">
          <thead>
            <th>Category</th>
            <th>Early Registration (before 15th August, 2024)</th>
            <th>Late Registration (after 15th August, 2024)</th>
          </thead>
          <tbody>
            <tr>
