...
const PosterPaper = () => {
  return (
    <div className='flex flex-wrap md:flex-nowrap mb-10 gap-6'>
...
2.Kindly ensure your paper is formatted s (not exceeding 8 pages written in A4 size).All papers must be submitted online via <a className='text-blue-500 underline' href='https://cmt3.research.microsoft.com/User/Login?ReturnUrl=%2FICICC2025'>Microsoft CMT Submission Portal</a> <br/>
...
<h1 className=' font-bold text-blue-950 text-3xl mt-8 mb-4'>Plagiarism Policy</h1>
<p>1)The paper prior to submission should be checked for plagiarism from licensed plagiarism softwares like Turnitin/iAuthenticate etc. The similarity content should not exceed 20% (in any case either self contents or others). Further, you have to strictly implement the following ethical guidelines for publication.
<br/>2)Any form of self-plagiarism or plagiarism from others work(s) should not be there in an article.
...
<br/>3)Also language of explaining it should not be same as language of the work from which you have adopted it.
