  ...
  return (
    <div className="flex imp testimonials bg-neutral-100 flex-col gap-5">
      ...
      <div className="flex flex-col text-lg">
        ...
        ICDPN-2024 will be organised by Institute of Technology and Business in České Budějovice, Near Prague, Czech Republic, Europe (Venue) on 19th - 20th October 2024.
        </p>
