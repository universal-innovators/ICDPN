  ...
  return (
    <div className="flex imp testimonials bg-neutral-100 flex-col gap-5">
      ...
      <div className="flex flex-col text-lg leading-loose">
        <h2 className="text-gray-600">Deadline for Manuscript submission: <span className="text-gray-500">15th August 2024</span></h2>
        <h2 className="text-gray-600">Notification of first review: <span className="text-gray-500">25th August 2024</span></h2>
        <h2 className="text-gray-600">Submission of revised Manuscript: <span className="text-gray-500">05th September 2024</span></h2>
        <h2 className="text-gray-600">Notification of final acceptance: <span className="text-gray-500">15th September 2024</span></h2>
