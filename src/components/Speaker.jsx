...
const Speaker = () => {
  return (
    <>
    <h1 className='text-center font-extrabold text-blue-900 text-5xl mb-8 mt-12'>Keynote Speakers of ICICC-2025 Conference</h1>
    <Swiper
        effect={'coverflow'}
        grabCursor={true}
        centeredSlides={true}
        ...
        className="mySwiper"
      >
        <SwiperSlide className='swiper-slide rounded-2xl text-gray-900 bg-gradient-to-r from-cyan-300 to-blue-900' >
        ...
        <SwiperSlide className='swiper-slide rounded-2xl bg-gradient-to-r from-cyan-300 to-blue-900'>
